...
\subsection{Compléxité en espace}
  \begin{center}
    \begin{tabular}{| m{2cm} | m{2cm} | m{2cm} | c | c|}
    \hline
    Fichiers traités & Holdall (LDSC) & Holdall (TAB DYN) & Nb de mots & Taille des fichiers\\ [0.5ex] 
    \hline\hline
    Les misérables / Domjuan & ~676000 & ~611000  & 64497 & 3.1Mo / 100ko\\ 
    \hline
    fr / abeeillmrsss / tartuffe & ~1.7M & ~1.2M & 401574 & 3.9Mo / 3.1Mo / 116ko\\
    \hline
    toto0 / toto1 / toto2 / toto3 & 463 & 343 & 127 & 159o / 192o / 320o / 167o\\ [1ex] 
    \hline
    \end{tabular}
  \end{center}
\paragraph{} 
...
\begin{center}
  \begin{tabular}{| m{2cm} | m{2cm} | m{2cm} | c | c|} 
  \hline
  Fichiers traités & Holdall (LDSC) & Holdall (Tableau dynamiques) & Nombre de mots & Taille des fichiers\\ [0.5ex] 
  \hline\hline
  Les misérables / Domjuan & ~0.9s & ~2.1s & 64497 & 3.1Mo / 100ko\\ 
  \hline
  fr / abeeillmrsss / tartuffe & ~1.5s & ~45s & 401574 & 3.9Mo / 3.1Mo / 116ko\\
  \hline
  toto0 / toto1 / toto2 / toto3 & ~0.004s & ~0.2s & 127 & 159o / 192o / 320o / 167o\\ [1ex]
  \hline
  \end{tabular}
\end{center}
\paragraph{}
