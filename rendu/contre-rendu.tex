...
Les modules utilisés sont: \textbf{avl}, \textbf{holdall}, \textbf{jdis}, \textbf{op}.
...
Nous avons décider de conserver le module avec les LDSC pour privillégier l'efficacité temporelle de notre exécutable.
