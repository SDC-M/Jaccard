...
déjà dedans nous libérons l'éspace mémoire associé au mot puis nous ajoutons la référence à l'arbre 
binaire de recherche associé au fichier dans tous les cas. À la fin de la lecture, nous avons
un arbre contenant des pointeurs vers les mots eux-mêmes contenus dans l'arbre des unions.
Il est donc à noté que pour l'ensemble des mots traités nous n'avons pas de doublons 
