...
\begin{center}
  \begin{tikzpicture}
    ...
    \node at (-11, -8) {\textit{\textbf{Holdall :}}};
...
\textbf{Sans module holdall sur la version finale du projet (À REFAIRE SUR LES MACHINES DE LA FAC )}
\begin{center}
\begin{tikzpicture}
...
\paragraph{\texttt{--V--V--V--} AMÉLIORATIONS POSSIBLEMENT FAITE \texttt{--V--V--V--}} 
...
Ce qui nous ferais gagner pas mal de temps.
