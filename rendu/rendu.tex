...
\begin{center}
  \begin{tikzpicture}
    ...
    \draw[->, color=red, bend left=10, dashed] (-6, -15.5) to (case7);
    \draw[->, color=red, bend left=5, dashed] (-6.5, -10.5) to (case4);
    \draw[->, color=red, dashed] (-3.75, -17.5) to (case8);
    \draw[->, color=red, bend left=5, dashed] (-2.75, -12.5) to (case12);
    \draw[->, color=red, bend left=5, dashed] (-1.5, -15.5) to (case11);
    \draw[->, color=red, bend right=10, dashed] (-0.3, -12.5) to (case9);
    \draw[->, color=red, bend right=10, dashed] (-5, -12.5) to (case10);
...
\textbf{Avec le module holdall implémenté par LDSC: (À REFAIRE SUR LES MACHINES DE LA FAC )}
\begin{center}
\begin{tikzpicture}
...
pour nous permettre de parcourir l'arbre "union" et ainsi libérer les références. Et cette méthode, c'est avérée la meilleure au vu des résultats.
