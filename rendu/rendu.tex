...
une zone mémoire permettant de stocker ce mot dans l'arbre des unions et l'ajoutons de la même façon à l'arbre du 
fichier concerné. À la fin de la lecture, nous avons un arbre contenant des pointeurs vers les mots eux-mêmes contenus 
dans l'arbre des unions. Il est donc à noté que pour l'ensemble des mots traités nous n'avons pas de doublons de mots.
